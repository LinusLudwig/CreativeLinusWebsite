<?php
    ...
    if(isset($_GET['code'])){
	echo $_GET['code'];
	//header("Location: https://api.epicgames.dev/epic/oauth/v1/token/1.1?grant_type=authorization_code&deployment_id=533a5c269cb44f94bf47572ac71ba488&scope=basic_profile&code=" . $_GET['code'] . "&redirect_uri=https://attackonscore.com/indextest2.php&client_id=xyza7891aTH5qQewL8HZKeeSHf9oJJDA&client_secret=BbKQseT+vaBrWuJihsLndlLDdkZ/DtJNw8enVFxL2q4/");
	$fields = [ 'Authorization' => 'Basic ' . $_GET['code'], 'grant_type' => 'authorization_code', 'deployment_id' => '533a5c269cb44f94bf47572ac71ba488', 'scope' => 'basic_profile', 'code' => $_GET['code'], 'redirect_uri' => 'https://attackonscore.com/indextest2.php/']; 
	$postdata = http_build_query($fields); 
	$ch = curl_init(); 
	curl_setopt($ch,CURLOPT_URL, 'https://api.epicgames.dev/epic/oauth/v1/token'); 
...
<body>
	...
	<div class="text-center p-5 card container" style="text-align: right;">
		<a href="https://www.epicgames.com/id/authorize?client_id=xyza7891aTH5qQewL8HZKeeSHf9oJJDA&response_type=code&scope=basic_profile&redirect_uri=https://attackonscore.com/indextest2.php/&state=rfGWJux2WL86Zxr6nKApCAnDo8KexEUE">Login</a>
		<?php echo "<p>Code: " . $_GET['code'] . "</code>"; ?>
		<a href='http://api.epicgames.dev/epic/oauth/v1/token?grant_type=authorization_code&deployment_id=533a5c269cb44f94bf47572ac71ba488&scope=basic_profile&code=&redirect_uri=https://attackonscore.com/indextest2.php'>Login to aos</a>
	}
	</div>
