		...
		if($count > 0)
		{
			...
			//{
				...
				//{
					...
					//if($badges == "")
					//{
						//$badges = "aos1kbadge.png";
					//}
				//}
			//}
			
			$query = "INSERT INTO Scores SET name = '$politestring', score = '$score', ts = CURRENT_TIMESTAMP ON DUPLICATE KEY UPDATE ts = if('$score'>score,CURRENT_TIMESTAMP,ts), score = if ('$score'>score, '$score', score);";
