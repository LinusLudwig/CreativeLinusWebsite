...
<head>
  ...
  <title>Anfrage Erfolgreich - UZG-Transporte</title>
</head>
<body>
    ...
    <button type="button" class="on-scroll-hidden mx-max shadow-card mt-0 align-self-end btn text-medium bg-company rounded-5 px-5" onclick="location.href='https://uzg-transporte.de/'">Hauptseite</button>
