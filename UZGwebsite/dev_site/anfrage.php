	...
	<div class="on-scroll-hidden mx-max text-center">
		...
		<div class="card rounded-4 p-1 mb-5 border-5" style="border-color: #1F6C7C;">
        	<div class="card-body">
				...
				<!-- action="submitinquiry.php" -->
            	<form data-multi-step method="post" id="form" action="angefragt.php" onsubmit="return sendData(event)">
					<!-- prevent form submission enter -->
					<button type="submit" disabled style="display: none" aria-hidden="true"></button>

					<div class="pb-2 stepDisplay">
						<ul>
							<li data-step-display class="activeNum" style="padding-right: 1px">1</li>
							<li data-step-display>2</li>
							<li data-step-display>3</li>
						</ul>
					</div>
					<div class="Basisdaten p-1 border rounded-4 active" data-step>
						<h2>1. Basisdaten</h2>		
						<p><span style="color: red;">*</span> = Pflichtfeld</p>
						<!-- Personendaten -->
						<div class="mt-2 card rounded-4">
							...
							<div class="collapse show" id="collapsePersonendaten">
								<div class="form-group row my-3">
									...
									<div class="col-sm-9">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="anrede" id="anredeRadio1" value="Herr">
											<label class="form-check-label" for="anredeRadio1">Herr</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="anrede" id="anredeRadio2" value="Frau">
											<label class="form-check-label" for="anredeRadio2">Frau</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="anrede" id="anredeRadio3" value="Divers">
											<label class="form-check-label" for="anredeRadio3">Divers</label>
										</div>
									</div>
								</div>
								<div class="form-group row my-3">
								...
								<div class="form-group row my-3">
									...
									<div class="col-sm-9">
										<input type="email" class="form-control rounded-4 text-center" required id="email" name="email" placeholder="beispiel@email.de" style="border: none; background-color: #f2f2f2;">
									</div>
								</div>
								<div class="form-group row my-3">
									<div class="col-sm-3">
								...
								<div class="form-group row my-3">
									...
									<div class="col-sm-9">
										...
										<div class="form-check form-check-inline">
											...
											<label class="form-check-label" for="DateRadio2">Frühstens</label>
										</div>
										<div class="form-check form-check-inline">
					...
					<div class="Umzugsliste p-1 border rounded-4" data-step>
						...
						<button type="button" onclick="roomAdd(this)" class="btn shadow-card bg-company mx-auto mt-2 rounded-3 d-block"><i class="bi bi-plus"></i> Raum Hinzufügen</button>
