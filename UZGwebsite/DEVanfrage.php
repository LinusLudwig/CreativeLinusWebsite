...
<head>
  ...
  <script defer src="/DEVjs_onlineinquiry.js"></script>
</head>
<body>
	...
	<div class="on-scroll-hidden mx-max text-center">
		...
		<div class="card rounded-4 p-1 mb-5 border-5" style="border-color: #1F6C7C;">
        	<div class="card-body">
            	...
            	<form data-multi-step method="post" id="form" action="DEVsubmitinquiry.php" onsubmit="submit2(event)">
					<div class="Basisdaten p-1 border rounded-4 active" data-step>
						...
						<!-- test -->
						<div class="col-sm-9">
							<input type="text" class="form-control rounded-4 text-center" id="69" name="69" placeholder="Herr Max Mustermann" style="border: none; background-color: #f2f2f2;">
							<button type="button" onclick="test()" class="shadow-card mt-2 btn text-medium bg-company rounded-5 px-5 d-block mx-auto">Test</button>
						</div>
