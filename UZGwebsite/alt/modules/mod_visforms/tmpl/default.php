...
?>
        ...
        jQuery('.captcharefresh<?php echo $visforms->id; ?>').bind({
            'click' : function() {
                ...
                {
                    jQuery('#captchacode<?php echo $visforms->id; ?>').attr('src', 'index.php?option=com_visforms&task=captcha&sid=' + Math.random()+ '&id=<?php echo $visforms->id; ?>');
                }
            }
        });	
});
