...
{
    var typesLabelCss = ['visf_submit', 'visf_reset', 'visf_image', 'visf_fieldsep', 'visf_hidden'];
    var typesFieldCss = ['visf_hidden'];
    var typesInculdeFieldOnExport = ['visf_submit', 'visf_reset', 'visf_image', 'visf_fieldsep'];
    var typesAllowUrlParam = ['visf_submit', 'visf_reset', 'visf_image', 'visf_fieldsep', 'visf_textarea', 'visf_file'];
    var typesUniqueValues = ['visf_submit', 'visf_reset', 'visf_image', 'visf_fieldsep'];
    var typesFrontendDisplay = ['visf_submit', 'visf_reset', 'visf_image', 'visf_fieldsep'];
    var typesCustomText = ['visf_hidden'];
    var typesBoostrapSize = ['visf_hidden', 'visf_submit', 'visf_reset', 'visf_image'];
    if (typesLabelCss.contains(type))
    {
            $('jform_labelCSSclass').set('disabled', true);
    }
    else
    {
            $('jform_labelCSSclass').set('disabled', false);
    }
    if (typesFieldCss.contains(type))
    {
            $('jform_fieldCSSclass').set('disabled', true);
    }
    else
    {
            $('jform_fieldCSSclass').set('disabled', false);
    }
    if (typesInculdeFieldOnExport.contains(type))
    {
        $('jform_includefieldonexport').getParents('.control-group').set('style', 'display: none;');
    }
    else
    {
        $('jform_includefieldonexport').getParents('.control-group').removeProperty('style');
    }
    if (typesAllowUrlParam.contains(type))
    {
        $('jform_allowurlparam').getParents('.control-group').set('style', 'display: none;');
    }
    else
    {
        $('jform_allowurlparam').getParents('.control-group').removeProperty('style');
    }
    if (typesUniqueValues.contains(type))
    {
        $('jform_uniquevaluesonly').getParents('.control-group').set('style', 'display: none;');
    }
    else
    {
        $('jform_uniquevaluesonly').getParents('.control-group').removeProperty('style');
    }
    if (typesFrontendDisplay.contains(type))
    {
        $('jform_frontdisplay').getParents('.control-group').set('style', 'display: none;');
        $('jform_frontaccess').getParents('.control-group').set('style', 'display: none;');
    }
    else
    {
        $('jform_frontdisplay').getParents('.control-group').removeProperty('style');
        $('jform_frontaccess').getParents('.control-group').removeProperty('style');
    }
    if (typesCustomText.contains(type))
    {
        $('jform_customtext').getParents('.control-group').set('style', 'display: none;');
        $('jform_customtextposition').getParents('.control-group').set('style', 'display: none;');        
    }
    else
    {
        $('jform_customtext').getParents('.control-group').removeProperty('style');
        $('jform_customtextposition').getParents('.control-group').removeProperty('style');
    }
    if (typesBoostrapSize.contains(type))
    {
        $('jform_bootstrap_size_chzn').addClass('chzn-disabled');
        $('jform_bootstrap_size_chzn').fireEvent('liszt:updated');
        $('jform_bootstrap_size').getParents('.control-group').set('style', 'display: none;');
        $('item-form').getElement('.hiddenbtsize').getParents('.control-group').set('style', 'display: none;');
    }
    else
    {
        $('jform_bootstrap_size_chzn').removeClass('chzn-disabled');
        $('jform_bootstrap_size_chzn').fireEvent('liszt:updated');
        $('jform_bootstrap_size').getParents('.control-group').removeProperty('style');
        $('item-form').getElement('.hiddenbtsize').getParents('.control-group').removeProperty('style');
    }
}
