...
/**
 * create visforms default multi checkbox HTML control
 *
 * @package		Joomla.Site
 * @subpackage	com_visforms
 * @since		1.6
 */
class VisformsHtmlControlBtdefaultMulticheckbox extends VisformsHtmlControl
{
   ...
   public function getControlHtml ()
   {
        ...
        $html = '';
        $layout = new JLayoutFile('visforms.btdefault.multicheckbox.control', null);
   ...
   public function createLabel()
   {
        ...
        $layout = new JLayoutFile('visforms.btdefault.multicheckbox.label', null);
        $layout->setOptions(array('component' => 'com_visforms'));
        $html .= $layout->render(array('field' => $field));
        return $html;
   }
