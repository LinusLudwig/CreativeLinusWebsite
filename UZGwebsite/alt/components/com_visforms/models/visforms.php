...
class VisformsModelVisforms extends JModelLegacy
{
    ...
    */
     ...
     public function getFields()
     {
         ...
         $visform = $app->getUserState('com_visforms.form' . $this->_id );
         $n=count($fields );
         //prepare HTML
            for ($i=0; $i < $n; $i++)
            {
	 ...
	 */
        ...
        private function storeData(&$visform)
        {
            ...
            $visform->dataRecordId = $dba->insertid();            
        ...
        private function sendReceiptMail($visform)
        {
            ...
            {
                $mailBody .= JText::_( 'COM_VISFORMS_RECORD_SET_ID' ) . " : " . $visform->dataRecordId . "<br />";
            }
        ...
        private function sendResultMail($visform)
        {
            ...
            if (((isset($visform->emailresulttext))) && ($visform->emailresulttext != ""))
            {
